											...
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													...
													<div class="summary-footer">
														<a class="text-muted text-uppercase" href="<?= base_url("index.php/cliente/");?>">(VISUALIZAR TODOS)</a>
													</div>
												</div>
											</div>
										</div>
									...
									<section class="panel panel-featured-left panel-featured-secondary">
										<div class="panel-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">Contas Vencendo Hoje</h4>
														<div class="info">
															<strong class="amount">EM DESENVOLVIMENTO</strong>
														</div>
													</div>
													<div class="summary-footer">
														<a class="text-muted text-uppercase">(VISUALIZAR TODAS)</a>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="panel-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													...
													<div class="summary-footer">
														<a class="text-muted text-uppercase">(VISUALIZAR TODOS)</a>
													</div>
												</div>
											</div>
										</div>
								...
								<div class="panel-body">
									<div class="row">
												...
												<h2>
													...
													<strong>
														<select class="form-control" id="salesSelector">
															<option value="Porto Admin" selected>PLANO A</option>
															<option value="Porto Drupal" >PLANO B</option>
															<option value="Porto Wordpress" >PLANO C</option>
														</select>
													</strong>
												</h2>
										...
										<div class="col-lg-4 text-center">
											<h2 class="panel-title mt-md">Objetivo</h2>
											<div class="liquid-meter-wrapper liquid-meter-sm mt-lg">
												<div class="liquid-meter">
													<meter min="0" max="100" value="35" id="meterSales"></meter>
												</div>
												<div class="liquid-meter-selector" id="meterSalesSel">
													<a href="#" data-val="35" class="active">Objetivo Mensal</a>
													<a href="#" data-val="28">Objetivo Anual</a>
												</div>
											</div>
										</div>
									</div>
