...
<body>
	...
	<div class="row">
		<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
			<section class="panel">
				<form id="frmCadCliente" method="POST" action='<?= base_url("index.php/contaReceber/add");?>'>
					<header class="panel-heading">
						...
						<h2 class="panel-title">Cadastro de Conta a Receber</h2>
					</header>
						...
						<div class="row">
							...
							<div class="col-sm-3">
								<div class="form-group">
									...
									<select id="txtCliente" name="txtCliente" class="select form-control">
								...
								<div class="form-group">
									...
									<select id="txtTipoConta" name="txtTipoConta" class="select form-control">
										...
										<?php foreach($tiposConta->result() as $item){?>
											<option value="<?= $item->codTipoContaReceber;?>"><?= $item->descricao;?></option>
										<?php } ?>
									</select>
								</div>
							</div>
...
<script src="<?= base_url("assets/paginas/cadastro_conta_receber.js");?>"></script>